...
class CheckpointManagerOptionsTest(parameterized.TestCase):
    ...
    @parameterized.parameters(
        ...
        ({"save_interval_steps": 0, "max_to_keep": 1},),
        (
            {
        ...
        ({"save_interval_steps": 0, "keep_period": 1},),
        ({"save_interval_steps": 0, "create": True},),
        ({"save_interval_steps": 0, "create": False, "cleanup_tmp_directories": True},),
        (
            {
                "save_interval_steps": 0,
                "create": False,
    ...
    @parameterized.named_parameters(
        dict(
            ...
            expected_single_host_load_and_broadcast=None,
